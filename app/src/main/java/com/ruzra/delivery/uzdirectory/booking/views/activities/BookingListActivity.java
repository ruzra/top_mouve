...
import com.ruzra.delivery.uzdirectory.adapter.lists.CategoriesListAdapter;
import com.ruzra.delivery.uzdirectory.animation.LineItemDecoration;
...
import com.ruzra.delivery.uzdirectory.booking.controllers.adapters.BookingListExpandAdapter;
import com.ruzra.delivery.uzdirectory.booking.controllers.parser.ReservationParser;
    ...
    private void getOrdersFromApi(final int page, final int order_id) {
        ...
        SimpleRequest request = new SimpleRequest(Request.Method.POST,
            ...
            protected Map<String, String> getParams() {
                ...
                if (APP_DEBUG) {
                    Log.e("BookingListActivity", "  params getOrders :" + params.toString());
                }
