...
import com.ruzra.delivery.uzdirectory.booking.controllers.ProductsController;
import com.ruzra.delivery.uzdirectory.booking.controllers.services.GenericNotifyEvent;
import com.ruzra.delivery.uzdirectory.booking.modals.CF;
...
import com.ruzra.delivery.uzdirectory.booking.views.fragments.checkout.BookingInfoFragment;
import com.ruzra.delivery.uzdirectory.booking.views.fragments.checkout.ConfirmationFragment;
import com.ruzra.delivery.uzdirectory.booking.views.fragments.checkout.PaymentFragment;
...
import com.ruzra.delivery.uzdirectory.customView.PaymentWebViewActivity;
...
import static com.ruzra.delivery.uzdirectory.security.Security.newInstance;
...
public class BookingCheckoutActivity extends AppCompatActivity {
    ...
    private void handleIntentAction() {
        ...
        if (getIntent().hasExtra("module_id") && getIntent().hasExtra("module")) {
            ...
            if (mStore != null && mStore.getServices() != null) {
                defaultCurrency = mStore.getServices().get(0).getCurrency();
            }
