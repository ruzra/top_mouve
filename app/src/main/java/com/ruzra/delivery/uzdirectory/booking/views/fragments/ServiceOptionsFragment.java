package com.ruzra.delivery.uzdirectory.booking.views.fragments;
...
import com.ruzra.delivery.uzdirectory.booking.controllers.CartController;
                            ...
                            radioBtn.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    for (int i = 0; i < service.getOptions().size(); i++) {
                                        if (view.getId() == service.getOptions().get(i).getId()) {
                                    ...
                                    if (((RadioButton) view).isChecked()) {
                                        ...
                                        if (option.getValue() > 0) {
                                            ...
                                            product_value.setText(String.format(OfferUtils.parseCurrencyFormat(
                                                    (customPrice > 0) ? customPrice : option.getValue(),
                                                    mServices.get(0).getCurrency())));
                                        }
