...
import com.ruzra.delivery.uzdirectory.activities.StoresListActivity;
import com.ruzra.delivery.uzdirectory.adapter.lists.StoreListAdapter;
    ...
    private void setRecyclerViewAdapter() {
        ...
        showMore.findViewById(R.id.card_show_more).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Intent featuredStrIntent = new Intent(mContext, StoresListActivity.class);
                featuredStrIntent.putExtra("searchParams", searchParams);
                mContext.startActivity(featuredStrIntent);
            }
        });
